---
layout: default
title: "Alpha60 Swarm Results 2017"
...
- Media Objects
{% capture media_objects %}{% include year-2017-0-media-objects.txt %}{% endcapture %}{{ media_objects | replace: '.md)', '.html)' }}
...
- [Year-2017 data](https://github.com/alpha60-devops/alpha60-results-2017/tree/main/data)

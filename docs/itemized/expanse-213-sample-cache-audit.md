...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2017/refs/heads/main/data/geojson.cumulative/expanse-213-cumulative-aggregate.geojson.gz" data-map-title="The Expanse — expanse-213" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open The Expanse (expanse-213) cumulative data map in new window" title="Opens interactive map for The Expanse (expanse-213) data">Swarm Detail</a>

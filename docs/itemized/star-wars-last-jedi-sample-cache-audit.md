...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2017/refs/heads/main/data/geojson.cumulative/star-wars-last-jedi-cumulative-aggregate.geojson.gz" data-map-title="Star Wars The Last Jedi — star-wars-last-jedi" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Star Wars The Last Jedi (star-wars-last-jedi) cumulative data map in new window" title="Opens interactive map for Star Wars The Last Jedi (star-wars-last-jedi) data">Swarm Detail</a>

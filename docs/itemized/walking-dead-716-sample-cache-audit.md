...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2017/refs/heads/main/data/geojson.cumulative/walking-dead-716-cumulative-aggregate.geojson.gz" data-map-title="The Walking Dead — walking-dead-716" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open The Walking Dead (walking-dead-716) cumulative data map in new window" title="Opens interactive map for The Walking Dead (walking-dead-716) data">Swarm Detail</a>
